...
public class AMTKRealtimeMain {

    private static final org.slf4j.Logger _log = LoggerFactory.getLogger(AMTKRealtimeMain.class);
    ...
    private AMTKRealtimeProvider _provider;
    ...
    public static void main(String[] args) throws Exception {
        AMTKRealtimeMain m = new AMTKRealtimeMain();
        try {
            m.run(args);
    ...
    @Inject
    public void setProvider(AMTKRealtimeProvider provider) {
        _provider = provider;
    }
